...
public class SharedObjectOutputStream extends OutputStream {
	...
	public SharedObjectOutputStream(StreamSender sender, int size,
	...
	public SharedObjectOutputStream(StreamSender obj, int size)
			throws IOException {
		this(obj, size, DEFAULT_COMPRESSION);
	}

	public SharedObjectOutputStream(StreamSender obj, boolean compression)
			throws IOException {
