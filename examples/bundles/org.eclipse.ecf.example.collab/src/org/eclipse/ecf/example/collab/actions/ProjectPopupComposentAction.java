...
public class ProjectPopupComposentAction implements IObjectActionDelegate {

	/**
	 * Constructor for Action1.
	 */
	public ProjectPopupComposentAction() {
		super();
	}
	...
	public void run(IAction action) {
        ClientConnectComposentAction caction = new ClientConnectComposentAction();
