...
public class ProjectPopupOSLAction implements IObjectActionDelegate {

	/**
	 * Constructor for Action1.
	 */
	public ProjectPopupOSLAction() {
		super();
	}
	...
	public void run(IAction action) {
        ClientConnectOSLAction caction = new ClientConnectOSLAction();
