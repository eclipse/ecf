...
public class TopologyManagerImpl extends AbstractTopologyManager implements EventHook, EndpointListener {
	...
	public void start() throws Exception {
		...
		// Register as EventHook, so that we get notified when remote services are registered
