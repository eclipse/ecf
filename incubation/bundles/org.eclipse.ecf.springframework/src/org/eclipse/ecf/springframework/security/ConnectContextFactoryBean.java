 ...
 * 
 */
public class ConnectContextFactoryBean implements FactoryBean,
	...
	public Class getObjectType() {
		return (this.connectContext != null ? this.connectContext.getClass()
				: IConnectContext.class);
	}
	...
	public void afterPropertiesSet() throws Exception {
		if (username == null) {
			this.connectContext = ConnectContextFactory
					.createPasswordConnectContext(password.toString());
		} else {
			this.connectContext = ConnectContextFactory
