 ...
 * @generated
 */
public class IServiceIDItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceID_ecfServiceName_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_IServiceID_ecfServiceName_feature", "_UI_IServiceID_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ModelPackage.Literals.ISERVICE_ID__ECF_SERVICE_NAME,
				 false,
				 false,
				 false,
	...
	protected void addServiceTypeIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceID_serviceTypeID_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_IServiceID_serviceTypeID_feature", "_UI_IServiceID_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ModelPackage.Literals.ISERVICE_ID__SERVICE_TYPE_ID,
				 false,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IServiceID")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_IServiceID_type") : //$NON-NLS-1$
			getString("_UI_IServiceID_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
