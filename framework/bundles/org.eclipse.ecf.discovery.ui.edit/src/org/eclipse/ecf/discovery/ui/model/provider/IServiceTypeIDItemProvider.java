 ...
 * @generated
 */
public class IServiceTypeIDItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceTypeID_ecfNamingAuthority_feature"), //$NON-NLS-1$
				 getString("_UI_IServiceTypeID_ecfNamingAuthority_description"), //$NON-NLS-1$
				 ModelPackage.Literals.ISERVICE_TYPE_ID__ECF_NAMING_AUTHORITY,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				 getString("_UI_DiscoveryPropertyCategory"), //$NON-NLS-1$
				 null));
	}
	...
	protected void addEcfProtocolsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceTypeID_ecfProtocols_feature"), //$NON-NLS-1$
				 getString("_UI_IServiceTypeID_ecfProtocols_description"), //$NON-NLS-1$
				 ModelPackage.Literals.ISERVICE_TYPE_ID__ECF_PROTOCOLS,
				 false,
				 true,
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEcfScopesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceTypeID_ecfScopes_feature"), //$NON-NLS-1$
				 getString("_UI_IServiceTypeID_ecfScopes_description"), //$NON-NLS-1$
				 ModelPackage.Literals.ISERVICE_TYPE_ID__ECF_SCOPES,
				 false,
				 true,
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEcfServiceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceTypeID_ecfServiceName_feature"), //$NON-NLS-1$
				 getString("_UI_IServiceTypeID_ecfServiceName_description"), //$NON-NLS-1$
				 ModelPackage.Literals.ISERVICE_TYPE_ID__ECF_SERVICE_NAME,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEcfServicesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceTypeID_ecfServices_feature"), //$NON-NLS-1$
				 getString("_UI_IServiceTypeID_ecfServices_description"), //$NON-NLS-1$
				 ModelPackage.Literals.ISERVICE_TYPE_ID__ECF_SERVICES,
				 false,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IServiceTypeID")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_IServiceTypeID_type") : //$NON-NLS-1$
			getString("_UI_IServiceTypeID_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
