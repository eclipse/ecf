...
public class IServiceInfoItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceInfo_ecfName_feature"), //$NON-NLS-1$
				 getString("_UI_IServiceInfo_ecfName_description"), //$NON-NLS-1$
				 ModelPackage.Literals.ISERVICE_INFO__ECF_NAME,
				 false,
				 false,
				 false,
	...
	protected void addEcfLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceInfo_ecfLocation_feature"), //$NON-NLS-1$
				 getString("_UI_IServiceInfo_ecfLocation_description"), //$NON-NLS-1$
	...
	protected void addEcfPriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceInfo_ecfPriority_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_IServiceInfo_ecfPriority_feature", "_UI_IServiceInfo_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ModelPackage.Literals.ISERVICE_INFO__ECF_PRIORITY,
				 false,
				 false,
				 false,
	...
	protected void addEcfWeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceInfo_ecfWeight_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_IServiceInfo_ecfWeight_feature", "_UI_IServiceInfo_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ModelPackage.Literals.ISERVICE_INFO__ECF_WEIGHT,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addServiceIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IServiceInfo_serviceID_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_IServiceInfo_serviceID_feature", "_UI_IServiceInfo_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 ModelPackage.Literals.ISERVICE_INFO__SERVICE_ID,
				 false,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IServiceInfo")); //$NON-NLS-1$
	}
