	...
	private void makeActions() {
		...
		disconnectContainerAction
				.setDisabledImageDescriptor(ImageDescriptor
						.createFromURL(FileLocator.find(UiPlugin.getDefault()
								.getBundle(),
								new Path(DISCONNECT_ICON_DISABLED), null)));
		IDiscoveryController c = getController();
		if (c == null)
		...
		connectContainerAction.setImageDescriptor(ImageDescriptor.createFromURL(FileLocator
				.find(UiPlugin.getDefault().getBundle(), new Path(
						CONNECT_ICON_ENABLED), null)));
	}
