...
/**
 * Interface that must be implemented by extensions of the containerFactory extension point
 *
 */
public interface IContainerInstantiator {
	/**
	 * Create instance of IContainer.  This is the interface that container provider implementations
	 * must implement for the containerFactory extension point.  The caller may optionally
	 ...
	 * <p></p><p><b>   ContainerFactory.getDefault().createContainer("foocontainer",new String [] { java.lang.String }, new Object { "hello" });</b></p><p></p>
	 * 
	 * @param description the ContainerTypeDescription associated with the registered container provider
	 * implementation
