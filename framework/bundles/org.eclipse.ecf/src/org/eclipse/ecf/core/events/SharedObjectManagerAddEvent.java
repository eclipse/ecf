 ...
 *
 */
public class SharedObjectManagerAddEvent implements
    ...
    public SharedObjectManagerAddEvent(ID localContainerID, ID sharedObjectID, ISharedObject object, Map properties) {
