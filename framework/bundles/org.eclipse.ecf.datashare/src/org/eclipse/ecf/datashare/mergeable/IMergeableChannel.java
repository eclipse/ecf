 ...
 * of the RSS SSE protocol for sharing item information via RSS.  See <a href="http://msdn.microsoft.com/xml/rss/sse">Simple Sharing Extensions for RSS and OPML</a>
 * for a description of the RSS SSE protocol. 
 *
 */
public interface IMergeableChannel extends IIdentifiable, IAdaptable {
	/**
	 * Get list of IItems
	 * @return List of items.  Will not return null.  List contents will be of type IItem.
	 */
	public List getItems();
	/**
	 * Merget the currrent set of items with changes made remotely
	 * @throws MergeException thrown if local copy cannot be merged with remote changes
	 */
	public void merge() throws MergeException;
	/**
	 * Add item to set managed by this channel
	 * @param item the IItem to add
	 * @return true if added successfully, false if item already exists in set known to this channel
	 */
	public boolean addItem(IItem item);
	/**
	 * Change the description of the item identified by the given itemID 
	 * @param itemID the itemID of the IItem to change
	 * @param description the new description to change in the IItem
	 * @return true if item found and description changes, false if item not found
	 */
	 ...
	 * @throws PublishException if problem with publishing
	 */
