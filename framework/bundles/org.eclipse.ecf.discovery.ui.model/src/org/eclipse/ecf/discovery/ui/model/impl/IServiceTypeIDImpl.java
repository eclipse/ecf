...
public class IServiceTypeIDImpl extends EObjectImpl implements IServiceTypeID {
	...
	public String toString() {
		...
		result.append(" (ecfServiceTypeID: "); //$NON-NLS-1$
		result.append(ecfServiceTypeID);
		result.append(", ecfNamingAuthority: "); //$NON-NLS-1$
		result.append(ecfNamingAuthority);
		result.append(", ecfServices: "); //$NON-NLS-1$
		result.append(ecfServices);
		result.append(", ecfProtocols: "); //$NON-NLS-1$
		result.append(ecfProtocols);
		result.append(", ecfScopes: "); //$NON-NLS-1$
		result.append(ecfScopes);
		result.append(", ecfServiceName: "); //$NON-NLS-1$
