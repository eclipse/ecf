...
public class CallSessionErrorDetails implements Serializable {
	...
	private static final String SERVICE_UNAVAILABLE_NAME = "service-unavailable"; //$NON-NLS-1$
	private static final String UNSUPPORTED_MEDIA_NAME = "unsupported-media"; //$NON-NLS-1$
	private static final String UNSUPPORTED_TRANSPORTS_NAME = "unsupported-transports"; //$NON-NLS-1$
	private static final String BAD_REQUEST_NAME = "bad-request"; //$NON-NLS-1$
	private static final String UNKWOWN_ERROR_NAME = "unknown-error"; //$NON-NLS-1$
