...
public class Trace {
    private static final String TRACENAME = "org.eclipse.ecf.provider.datashare.Trace";
    ...
    protected static Trace errTrace = new Trace("org.eclipse.ecf.provider.datashare.Trace.err");
