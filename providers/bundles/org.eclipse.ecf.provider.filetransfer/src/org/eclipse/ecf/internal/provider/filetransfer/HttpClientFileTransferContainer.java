...
public class HttpClientFileTransferContainer extends AbstractContainer implements
	...
	public HttpClientFileTransferContainer() throws IDCreateException {
		this.id = IDFactory.getDefault().createLongID(this.hashCode());
	...
	public Object getAdapter(Class serviceType) {
		if (serviceType.equals(IRetrieveFileTransferContainerAdapter.class))
			return new HttpClientRetrieveFileTransfer(client);
		else
			return null;
	}
