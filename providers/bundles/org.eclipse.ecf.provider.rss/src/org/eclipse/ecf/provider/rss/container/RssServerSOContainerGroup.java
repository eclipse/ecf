...
import org.eclipse.ecf.provider.rss.http.HttpRequest;
import org.eclipse.ecf.provider.rss.http.HttpResponse;
...
public class RssServerSOContainerGroup extends SOContainerGroup implements ISocketAcceptHandler{
	...
	public static final Trace trace = Trace.create("connection");
	...
	public void handleAccept(Socket socket) throws Exception {
        ...
        RssServerSOContainer con = (RssServerSOContainer) get(String.valueOf(port));
        if(con == null) {
