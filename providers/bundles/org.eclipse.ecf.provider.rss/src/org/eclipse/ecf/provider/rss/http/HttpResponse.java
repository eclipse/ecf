...
public class HttpResponse extends HttpMessage {
    ...
    */
    ...
    /**
    * response ok (200) with string as body
    * default version
    */
    ...
    * and parses the startline for version, return code and reason.
    */
    ...
    private static String type2String( int type ) {
        switch( type ) {
            ...
            case SWITCH_PROTOCOLS: return "Switching Protocols";
            case OK: return "OK";
            case CREATED: return "Created";
            case ACCEPTED: return "Accepted";
            case NON_AUTHORATIVE: return "Non-Authorative Information";
            ...
            case METHOD_NOT_ALLOWD: return "Method Not Allowed";
            ...
            case LENGTH_REQUIRED: return "Lenght Required";
            case PRECONDITION_FAILED: return "Precondition Failed";
            case REQUEST_TOO_LARGE: return "Request Entity Too Large";
            case URI_TOO_LARGE: return "Request-URI Too Large";
            case UNSUPPORTED_MEDIA: return "Unsupported Media Type";
            case SERVER_ERROR: return "Internal Server Error";
            case NOT_IMPLEMENTED: return "Not Implemented";
            case BAD_GATEWAY: return "Bad Gateway";
            case UNAVAILABLE: return "Service Unavailable";
            case GATEWAY_TIMEOUT: return "Gateway Time-out";
            case VERSION_NOT_SUPPORTED: return "HTTP Version not supported";
            default: return "No Reason Phrase";
        }
    }
}
