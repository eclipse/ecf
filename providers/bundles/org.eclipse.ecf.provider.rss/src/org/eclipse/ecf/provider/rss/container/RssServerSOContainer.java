...
public class RssServerSOContainer extends ServerSOContainer {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // Get server identity
        String serverName = "//"+InetAddress.getLocalHost().getHostName()+":"+port;
        ...
        RssServerSOContainer server = new RssServerSOContainer(config, serverGroups[0], DEFAULT_KEEPALIVE);
        // Setup join policy
